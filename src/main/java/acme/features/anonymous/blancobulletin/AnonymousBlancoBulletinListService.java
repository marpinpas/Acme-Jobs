...
@Service
public class AnonymousBlancoBulletinListService implements AbstractListService<Anonymous, BlancoBulletin> {
	...
	@Override
	public Collection<BlancoBulletin> findMany(final Request<BlancoBulletin> request) {
		assert request != null;

		Collection<BlancoBulletin> result;
